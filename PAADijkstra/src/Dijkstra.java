...
public class Dijkstra {
    ...
    List<Vertice> menorCaminho = new ArrayList<Vertice>(); // Lista dos vertices pertencentes ao menor caminho
    Vertice caminho = new Vertice("caminho");   // Recebe o vertices de menor caminho
    Vertice atual = new Vertice("atual");    // Guarda o vertice que esta sendo visitado
    Vertice vizinho = new Vertice("vizinho");   // Marca o vizinho do vertice atualmente visitado
